  ...
  message.channel
    .send(
      new Discord.RichEmbed()
        ...
        .setDescription("Discord Stats Ayarlansın mı ?")
        ...
        .then(collected => {
          ...
          try {
            ...
            message.channel.send(
              `Sunucu panel için gerekli kanallar oluşturulup, ayarlamalar yapıldı!  \`(Oda isimlerini değiştirmeyin, çalışmaz! HER 10 DAKİKADA BİR GÜNCEL YAPAR BOT)\``
            );
          } catch (e) {
            console.log(e.stack);
          }
